...
FLASH_Status FLASH_ErasePage(uint32_t Page_Address)
{
  ...
  /* Check the parameters */
  assert(IS_FLASH_PROGRAM_ADDRESS(Page_Address));
...
FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
  ...
  /* Check the parameters */
  assert(IS_FLASH_PROGRAM_ADDRESS(Address));
...
FLASH_Status FLASH_OB_BOOT0SWConfig(uint8_t OB_BOOT0SW)
{
  ...
  /* Check the parameters */
  assert(IS_OB_BOOT0SW(OB_BOOT0SW));
...
FLASH_Status FLASH_OB_VDDAConfig(uint8_t OB_VDDA_ANALOG)
{
  ...
  /* Check the parameters */
  assert(IS_OB_VDDA_ANALOG(OB_VDDA_ANALOG));
...
FLASH_Status FLASH_OB_SRAMParityConfig(uint8_t OB_SRAM_Parity)
{
  ...
  /* Check the parameters */
  assert(IS_OB_SRAM_PARITY(OB_SRAM_Parity));
